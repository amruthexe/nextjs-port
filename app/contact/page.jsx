...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "+91 6281209224", // Karthik's phone number
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "karthik123medaka@gmail.com", // Karthik's email address
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Location",
    description: "India", // Karthik's location
  },
];
...
const Contact = () => {
  ...
  async function handleSubmit(event) {
    ...
    formData.append("access_key", "fdc4e769-5a54-4a01-a360-b3063d999714");
